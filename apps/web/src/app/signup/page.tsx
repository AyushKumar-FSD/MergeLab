  ...
  return (
    <main className="relative min-h-screen bg-[#16121e] px-6 py-16 text-[#e6e1f2] sm:px-8 lg:px-10">
      ...
      <div className="mx-auto max-w-xl rounded-2xl border border-[rgba(255,255,255,0.1)] bg-[rgba(255,255,255,0.05)] p-8">
        <div className="mb-8">
          <p className="text-sm uppercase tracking-[0.3em] text-[#c5b3e6]">Sign up</p>
          <h1 className="mt-4 text-3xl font-semibold tracking-tight text-[#e6e1f2]">Create your MergeLab account.</h1>
          <p className="mt-2 text-sm text-[#9d93b3]">
            Join MergeLab and keep your work across sessions.
          </p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label className="mb-2 block text-sm font-medium text-[#e6e1f2]" htmlFor="name">
              Full name
            </label>
            <input
              id="name"
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div>
              <label className="mb-2 block text-sm font-medium text-[#e6e1f2]" htmlFor="confirmPassword">
                Confirm password
              </label>
              <div className="relative">
                <input
